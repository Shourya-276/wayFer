...
export const ProductShowcase: React.FC = () => {
  ...
  const screens = [
    ...
    },
    {
      ...
      description:
        "Enter your pickup and dropoff points with precise gate drops. Tap 'Book Ride' to trigger WayFer's smart algorithm, which maps intersecting route vectors to find riders heading the exact same way.",
    ...
    },
    {
      ...
      description:
        'Choose today or schedule ahead with flexible 15-minute departure slots to maximize overlapping co-riders.',
