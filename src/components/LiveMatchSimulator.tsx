...
export const LiveMatchSimulator: React.FC = () => {
  ...
  return (
    <section className="relative py-28 px-4 sm:px-6 lg:px-8 bg-dark-950 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-white leading-tight">
            See who's <span className="text-gradient-brand">going your way</span>.
          </h2>
        ...
        <div className="rounded-3xl bg-[#080D18] border border-white/10 p-6 sm:p-10 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-white/10 mb-8">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-brand-green font-bold text-xs">
                A+C
              </div>
              <div>
          ...
          <div className="relative w-full aspect-[16/9] sm:aspect-[21/9] bg-[#050912] rounded-2xl border border-white/5 overflow-hidden flex items-center justify-center">
            
            <svg className="w-full h-full" viewBox="0 0 800 340" fill="none">
              {/* Background Roads */}
              <path d="M-50 170 L 850 170" stroke="#121D30" strokeWidth="22" />
              <path d="M400 -50 L 400 390" stroke="#121D30" strokeWidth="16" />
              <path d="M100 -50 Q 400 170 700 390" stroke="#0E1726" strokeWidth="12" />
              ...
              {/* Rider C Route (Nearby to Terminal - Converging with A) */}
              <path
              ...
              <g transform="translate(80, 260)">
                ...
                <text x="0" y="4" fill="#030507" fontSize="10" fontWeight="bold" textAnchor="middle">
                  A
                </text>
              </g>
            ...
            <div className="absolute z-20 transition-all duration-300 transform scale-100">
              {stage === 1 && (
                <div className="px-4 py-2 rounded-2xl bg-dark-950/90 border border-cyan-500/50 text-cyan-300 font-bold text-xs shadow-glow-cyan flex items-center gap-2">
              ...
              {stage === 2 && (
                <div className="px-5 py-2.5 rounded-2xl bg-dark-950/90 border border-emerald-500/50 text-white font-bold text-xs shadow-glow-green flex items-center gap-2">
                  <Navigation2 className="w-3.5 h-3.5 text-brand-green" />
                  Same direction • 94% alignment
                </div>
              )}

              {stage === 3 && (
                <div className="px-5 py-2.5 rounded-2xl bg-dark-900 border border-brand-green text-brand-green font-extrabold text-xs uppercase tracking-wider shadow-glow-green flex items-center gap-2">
              ...
              {stage === 4 && (
                <div className="px-6 py-3 rounded-full bg-gradient-to-r from-brand-green to-brand-cyan text-dark-950 font-black text-sm uppercase tracking-widest shadow-glow-green-lg flex items-center gap-2 animate-bounce">
            ...
            {/* Bottom Disclaimer */}
            <span className="absolute bottom-2 right-4 text-[9px] font-mono text-slate-500">
            ...
            {stageLabels.map((s, idx) => (
              <button
                ...
                className={`p-2.5 rounded-xl border text-center transition-all ${
                  stage === idx
                    ? 'bg-brand-green/15 border-brand-green/50 text-white font-bold'
